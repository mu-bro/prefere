    ...
    <div class="row">
        ...
        <div class="col-lg-6 shippingInfoBlock">
            ...
            <?php if (isset($delInfo['shipping_method']['info']['city'])) { ?>
                <div class="infoText"><b><?php echo $text_city; ?>:</b> <?php echo $delInfo['shipping_method']['info']['city']; ?>
                </div>
            <?php } ?>
            <?php if (isset($delInfo['shipping_method']['info']['address'])) { ?>
                <div class="infoText"><b><?php echo $text_addres; ?>
                        :</b> <?php echo $delInfo['shipping_method']['info']['address']; ?></div>
            <?php } ?>
            <div class="infoText"><b><?php echo $delivery_date; ?>:</b> <?php echo $delInfo['shipping_method']['info']['date']; ?>
            </div>
            <?php if ($delInfo['shipping_method']['code'] != 'flat.flat') { ?>
                <div class="infoText"><b><?php echo $delivery_time; ?>
                        :</b> <?php echo $delInfo['shipping_method']['info']['time']; ?></div>
            <?php } ?>

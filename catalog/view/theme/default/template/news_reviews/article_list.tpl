        ...
        <?php foreach ($articles as $article) { // BEGIN foreach ($articles as $article)
            ...
            <?php if ($design == 'simple') { ?>
                <div class="nr__article-list-item" itemscope itemtype="http://schema.org/Article">
                    <div>
                        ...
                        <?php } ?>
                        <a itemprop="url"
                           href="<?php echo $article['href']; ?>"><span itemprop="name"><?php echo $article['name']; ?></span></a>
                    </div>
                </div>
                ...
                <div class="row nr_article-list-item" itemscope itemtype="http://schema.org/Article">
                    <?php if ($article['thumb']) { ?>
                        <div class="<?php echo $col_size['L']; ?>">
                            <p class="nr__article-thumb"><a itemprop="url"
                                                            href="<?php echo $article['href']; ?>"><img title="<?php echo $article['name']; ?>"
                    ...
                    <div class="<?php echo $col_size['R']; ?>">
                        ...
                        <?php if ($article['date'] || $article['description']) { ?>
                            <p class="nr__article-desc">
                                <?php if ($article['date']) { ?>
                                    <span class="nr__date-published"
                                          itemprop="datePublished"><?php echo $article['date']; ?></span>
                                <?php } ?>
                            ...
                            <p>
                                <a class="pull-right" href="<?php echo $article['href']; ?>"><?php echo $text_num_view; ?></a>
                            </p>
                        <?php } ?>
                        <?php if ($article['viewed'] || $article['comment']) { ?>
                            <p class="nr__box-informer">
                                <?php if ($article['viewed']) { ?>
                                    <span class="nr__cnt-viewed" itemprop="interactionCount"><?php echo $text_num_view; ?>
                                        : <?php echo $article['viewed']; ?></span>
                                <?php } ?>
                                <?php if ($article['comment']) { ?>
                                    <span class="nr__cnt-comment"><a itemprop="commentCount"
                                                                     href="<?php echo $article['href']; ?>#cl"><?php echo $text_num_comment; ?>
                                            : <?php echo $article['comment']; ?></a></span>
                                <?php } ?>
                            </p>
                        <?php } ?>
                    </div>
            ...
            <?php } elseif ($design == 'two') { ?> <!-- BEGIN TWO COLUMN -->
                <?php if (!($i % 2)) { ?>
                    <div class="row">
                <?php } ?>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  nr__article-list-item"
                     itemscope
                    ...
                    <div class="row">
                        <?php if ($article['thumb']) { ?>
                            <div class="<?php echo $col_size['L']; ?>">
                                <p class="nr__article-thumb"><a itemprop="url"
                                                                href="<?php echo $article['href']; ?>">
                                        <img title="<?php echo $article['name']; ?>"
                                                                                                            alt="<?php echo $article['name']; ?>"
                                                                                                            class="img-responsive"
                                                                                                            itemprop="photo"
                                                                                                            src="<?php echo $article['thumb']; ?>"></a>
                        ...
                        <div class="<?php echo $col_size['R']; ?>">
                            ...
                            <?php if ($article['date'] || $article['description']) { ?>
                                <p class="nr__article-desc">
                                    ...
                                    <?php } ?>
                                    <?php if ($article['description']) { ?>
                                        <span class="nr_article-about"
                                              itemprop="about"><?php echo $article['description']; ?></span>
                                    <?php } ?>
                                </p>
                            <?php } ?>
                            <?php if ($article['viewed'] || $article['comment']) { ?>

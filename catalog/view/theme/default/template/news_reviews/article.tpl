...
<div class="container">
	...
	<div class="row">
		...
		<?php } ?>
		<div id="content" class="<?php echo $class; ?> centralBlock catalog mainBlock" itemscope itemtype="http://schema.org/Article">
				<h3 class="small"><span><?php echo isset($categories[0]['text']) ? $categories[0]['text'] : $heading_title; ?></span></h3>
			...
			<?php if($date_start || $thumb || $author || $viewed || $comment_status || $description) { ?>
				<h2 class="nr_subTitle"><?php echo $heading_title; ?></h2>
			...
			<p>
				<a class="pull-left" href="<?php echo $categories[0]['href']; ?>"><?php echo $button_continue; ?></a>
			</p>

		...
		$.ajax({
			...
			success: function(json) {
				...
				for( key in json ) {
					...
					html += '    <td valign="middle" style="width:90%;"><input ' + active + ' id="lng_text_' + json[ key ].code + '" type="text" name="lng_text[' + json[ key ].code + ']" value="' + json[ key ].value + '" style="width:94%;" class="span6" /></td>';
					html += '</tr>';
				}
				html += '</table>';
...
<div style="width:100%;height:40px;width:100%;background:#FFFFD0;;padding-bottom:7px;padding-top:5px;text-align:center;border-bottom:3px solid #333;position:fixed;top:0px;left:0px;z-index:10000;" id="edit-language-panel">
	...
	<div style="width:960px;margin:0px auto;">
		...
		<div style="float:right;">
			<button type="button" id="button-edit-language-start" class="btn btn-xs">Редактировать&nbsp;<i class="fa fa-pencil-square-o"></i></button>&nbsp;
			<button type="button" onclick="window.location = 'index.php?route=common/home&lng_editable=N'" class="btn btn-xs">Выход&nbsp;<i class="fa fa-power-off"></i></button>
		</div>
	</div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="form-edit-language-variable">
                    ...
                    <input id="lng_key" type="text" name="lng_key" value="" class="span4" style="width:70%;"/>
                </form>
            </div>

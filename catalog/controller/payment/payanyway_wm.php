...
class ControllerPaymentPayanywayWM extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_wm.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/payanyway_wm.tpl', $data);
		} else {
			return $this->load->view('default/template/payment/payanyway_wm.tpl', $data);
		}
	}

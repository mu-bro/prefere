...
class ControllerProductProduct extends Controller {
    ...
    public function index() {
        ...
        $this->document->addStyle('catalog/view/javascript/jquery/select/css/bootstrap-select.css');
        $this->document->addScript('catalog/view/javascript/jquery/select/js/bootstrap-select.js');
                ...
                foreach ($option['product_option_value'] as $option_value) {
                    if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
                        ...
                        if ($option_value['price_prefix'] == '+') {
                            $option_value['price'] = ($option['special_type'] != "size") ? ($option_value['price']) : ($product_info['price'] + $option_value['price']);
                        } else {
                            $option_value['price'] = ($option['special_type'] != "size") ? (- $option_value['price']) : $product_info['price'] - $option_value['price'];
                        }
                        ...
                        if ($option_value['value_image']) {
                            $popup = $this->model_tool_image->resize($option_value['value_image'], $this->config->get('config_image_popup_width'), $this->config->get('config_image_popup_height'));
                            $thumb = $this->model_tool_image->resize($option_value['value_image'], $this->config->get('config_image_thumb_width'), $this->config->get('config_image_thumb_height'));
                        } else {
                            $popup = $thumb = '';
                        }
...
//p($data['options']);
    ...
    public function fastorder() {
        ...
        $email_subject = $this->language->get('email_subject_fast_order');
        $email_body = sprintf($this->language->get('email_body_fast_order'),$foproduct,$name,$email_address,$phone,$message);
        ...
        $mail->setHtml($this->document->createMail($email_body));
//        echo $this->document->createMail($email_body);die;
        $mail->send();

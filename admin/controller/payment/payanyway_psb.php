...
class ControllerPaymentPayanywayPsb extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('payment/payanyway_psb', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_psb_status'])) {
			$data['payanyway_psb_status'] = $this->request->post['payanyway_psb_status'];
		} else {
			$data['payanyway_psb_status'] = $this->config->get('payanyway_psb_status');
		}

		if (isset($this->request->post['payanyway_psb_sort_order'])) {
			$data['payanyway_psb_sort_order'] = $this->request->post['payanyway_psb_sort_order'];
		} else {
			$data['payanyway_psb_sort_order'] = $this->config->get('payanyway_psb_sort_order');
		}
		...
		$this->response->setOutput($this->load->view('payment/payanyway_psb.tpl', $data));
	}

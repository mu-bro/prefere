            ...
            <div class="panel-body">
                <form id="form-payanyway"action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for=""><?php echo $entry_mnt_server; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for=""><?php echo $entry_payed_order_status; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for=""><?php echo $entry_mnt_id; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for=""><?php echo $entry_mnt_dataintegrity_code; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for=""><?php echo $entry_mnt_currency_code; ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for=""><?php echo $entry_mnt_test_mode; ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><select class="form-control" name="payanyway_banktransfer[payanyway_banktransfer_status]">
                                <?php if ($payanyway_banktransfer_status) { ?>
                                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                <option value="0"><?php echo $text_disabled; ?></option>
                                <?php } else { ?>
                                <option value="1"><?php echo $text_enabled; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control"
                                                      name="payanyway_banktransfer[payanyway_banktransfer_sort_order]"
                                                      value="<?php echo $payanyway_banktransfer_sort_order; ?>"/></div>
                    </div>
                </form>
            </div>
        </div>

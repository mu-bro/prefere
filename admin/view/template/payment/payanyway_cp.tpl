            ...
            <div class="panel-body">
                <form id="form-payanyway"action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><select class="form-control" name="payanyway_cp[payanyway_cp_status]">
                                <?php if ($payanyway_cp_status) { ?>
                                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                <option value="0"><?php echo $text_disabled; ?></option>
                                <?php } else { ?>
                                <option value="1"><?php echo $text_enabled; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control" name="payanyway_cp[payanyway_cp_sort_order]"
                                                      value="<?php echo $payanyway_cp_sort_order; ?>" size="1"/></div>
                    </div>

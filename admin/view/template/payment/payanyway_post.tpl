        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><select class="form-control" name="payanyway_post[payanyway_post_status]">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><input type="text" class="form-control" name="payanyway_post[payanyway_post_sort_order]"
                                                  value="<?php echo $payanyway_post_sort_order; ?>" size="1"/></div>
                </div>

            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>"
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-category">Показывать категории:</label>

                            <div class="col-sm-10">
                                <input type="text"
                                       name="category"
                                       value=""
                                       placeholder="Показывать категории:"
                                       id="input-category"
                                       class="form-control"/>

                                <div id="featured-category" class="well well-sm" style="height: 150px; overflow: auto;">
                                    <?php foreach ($categories as $category) { ?>
                                        <div id="featured-category<?php echo $category['category_id']; ?>">
        ...
        <script type="text/javascript"><!--
            ...
            $('input[name=\'category\']').autocomplete({
                ...
                'select': function (item) {
                    ...
                    $('#featured-category').append('<div id="featured-category' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="category_categories[]" value="' + item['value'] + '" /></div>');
                }
            });
            //--></script>
    </div>

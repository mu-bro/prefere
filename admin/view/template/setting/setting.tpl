            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#tab-flower" data-toggle="tab"><?php echo $flower_settings; ?></a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="tab-smartsupp">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="config_smartsupp_key"><span data-toggle="tooltip" title="Smartsupp Chat ID"><?php echo 'Smartsupp Chat ID'; ?></span></label>
                                <div class="col-sm-10">
                        ...
                        <div class="tab-pane active" id="tab-flower">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-admin-limit"><span data-toggle="tooltip" title="<?php echo $help_phone_mask; ?>"><?php echo $title_phone_mask; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_telephone_mask" value="<?php echo $config_telephone_mask; ?>" placeholder="<?php echo $config_telephone_mask; ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-admin-limit"><span data-toggle="tooltip" title="<?php echo $help_deliver_frames; ?>"><?php echo $title_deliver_frames; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_deliver_frames" value="<?php echo $config_deliver_frames; ?>" placeholder="<?php echo $config_deliver_frames; ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-admin-limit"><span data-toggle="tooltip" title="<?php echo $help_not_deliver_dates; ?>"><?php echo $title_not_deliver_dates; ?></span></label>
                                <div class="col-sm-10">
                                    <input type="hidden" id="config_not_deliver_dates" name="config_not_deliver_dates" value="<?php echo $config_not_deliver_dates; ?>"  class="form-control" />

                                    <div class="input-group" style="width:150px;">
                                        <input class="form-control" id="dateAdd" type="text"
                                               data-date-format="DD.MM.YYYY" />
                                            <span class="input-group-btn">
                                                <button type="button" class="btn btn-default" onclick="addDate();"><i class="fa
                                                fa-plus"></i></button>
                                            </span>
                                    </div>
                                    <div id="badgesBlock" class="badgesBlock"><?php
                                        foreach($exclDates as $date) {
                                            if (empty($date)) continue;
                                            echo '<span class="label label-default" rev="'.$date.'">'.$date.'<i class="fa
                                            fa-times"></i></span>'; } ?></div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >
                                    <?php echo $text_stores_list; ?>
                                </label>
                                <div class="col-sm-10">
                                    <input type="hidden" id="config_store_list" name="config_store_list" value="<?php echo $config_store_list; ?>"  class="form-control" />
                                    <div class="input-group" >

                                            <span class="input-group-btn">
                                        <input class="form-control" type="text" style="width:200px;" placeholder="<?php echo
                                        $text_city; ?>" id="cityInput"/>
                                        <input class="form-control" type="text" style="width:300px;" placeholder="<?php echo
                                        $text_link; ?>" id="linkInput"/>
                                                <button type="button" class="btn btn-default" onclick="addStore();"><i class="fa
                                                fa-plus"></i></button>
                                            </span>
                                    </div>
                                    <div id="badgesStoresBlock" class="badgesBlock"><?php
                                        foreach($storeList as $i => $store) {
                                            if (empty($store)) continue;
                                            echo '<span class="label label-default" rev="'.$i.'">'.$store['store'] . ': '. $store['link'] .'<i
                                            class="fa
                                            fa-times"></i></span>'; } ?></div>
                                </div>
                            </div>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" >
                                        <?php echo $title_soc_vk; ?>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="config_soc_vk" value="<?php echo $config_soc_vk; ?>" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" >
                                        <?php echo $title_soc_fb; ?>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="config_soc_fb" value="<?php echo $config_soc_fb; ?>"
                                               class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" >
                                        <?php echo $title_soc_pi; ?>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="config_soc_pi" value="<?php echo $config_soc_pi; ?>"
                                               class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" >
                                        <?php echo $title_soc_in; ?>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="config_soc_in" value="<?php echo $config_soc_in; ?>"
                                               class="form-control" />
                                    </div>
                                </div>
                            </fieldset>
                        ...
                        <div class="tab-pane" id="tab-store">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?> #1
                                </label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone; ?> #2
                                </label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_telephone_2" value="<?php echo $config_telephone_2; ?>" placeholder="<?php echo $entry_telephone; ?>" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
...
<!--                                 <div class="form-group">-->
<!--                                    <label class="col-sm-2 control-label" for="input-encryption"><span data-toggle="tooltip" title="Код от яндекс метрики или google analytics">Код метрики:</span></label>-->
<!--                                    <div class="col-sm-10">-->
<!--                                        <textarea name="config_store_metrics" rows="5" placeholder="Код метрики" class="form-control">--><?php //echo $config_store_metrics; ?><!--</textarea>-->
<!--                                    </div>-->
<!--                                </div>-->
                            </fieldset>
                            <fieldset>
    ...
    <script type="text/javascript"><!--
        ...
        $( document ).on( "click", "#badgesBlock .fa-times", function() {
            removeDate = $(this).parent().attr('rev');
            dates = $("#config_not_deliver_dates").val();
            dates = str_replace(', ' + removeDate,'',dates);
            dates = str_replace(removeDate,'',dates);
            $("#config_not_deliver_dates").val(dates);
            $(this).parent().remove();
        });
        function addDate() {
            var newDate = $("#dateAdd").val();
            dates = $("#config_not_deliver_dates").val();
            if (dates.indexOf(newDate) == -1) {
                ...
                $("#badgesBlock").append('<span class="label label-default" rev="'+newDate+'">'+newDate+'<i ' +
                'class="fa fa-times"></i></span>');
            }
        }
        storeArray = [];
        arrayIndex = 0;
        <?php foreach ($storeList as $i => $store) { ?>
            storeInfo = new Object;
            storeInfo.store =  '<?php echo $store['store'] ?>';
            storeInfo.link = '<?php echo $store['link'] ?>';
            storeArray[arrayIndex] = storeInfo;
            arrayIndex++;
        <?php } ?>
        $(document).on("click", "#badgesStoresBlock .fa-times", function () {
            removeStoreIndex = $(this).parent().attr('rev');
            storeArray.splice(removeStoreIndex, 1);
            $("#config_store_list").val(JSON.stringify(storeArray));
            $(this).parent().remove();
        });
        function addStore() {
            var store = $("#cityInput").val();
            var link = $("#linkInput").val();
            if (store == '' || link == '') return;

            var newValueLabel = store + ": " + link;
            storeInfo = new Object;
            storeInfo.store = store;
            storeInfo.link = link;
            storeArray[arrayIndex] = storeInfo;
            $("#config_store_list").val(JSON.stringify(storeArray));
            $("#badgesStoresBlock").append('<span class="label label-default" rev="' + arrayIndex + '">' + newValueLabel + '<i ' +
            'class="fa fa-times"></i></span>');
            arrayIndex++;
            $("#cityInput").val('');
            $("#linkInput").val('');

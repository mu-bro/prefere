    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo $invoice; ?>" target="_blank" data-toggle="tooltip"
                   title="<?php echo $button_invoice_print; ?>" class="btn btn-info"><i
                        class="fa fa-print"></i></a>
                <!--                <a href="--><?php //echo $shipping; ?><!--" target="_blank" data-toggle="tooltip"-->
                <!--                                                        title="-->
                <?php //echo $button_shipping_print; ?><!--" class="btn btn-info"><i-->
                <!--                        class="fa fa-truck"></i></a> -->
                <!--                <a href="--><?php //echo $edit; ?><!--" data-toggle="tooltip"-->
                <!--                                                        title="-->
                <?php //echo $button_edit; ?><!--" class="btn btn-primary"><i-->
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-history">
                        ...
                        <div class="text-right">
                            <button id="button-history" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">
